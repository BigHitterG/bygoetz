    ...
    fact: "Basil's footprint progression is intended to reward short map activities such as watering, planting, „}≠¢Gß≤⁄Óù∆≠y›,
      {
        ...
        body: "Short adventures around Basil's map can diversify how members play‚Äîand gradually open more room for them to plant in the community garden.",
  ...
  },
  {
    ...
    variants: [
      ...
      },
      {
        ...
        body: "A new flower joins the catalog, then Mary plants the first one. Small unlocks create new arrangements‚Äîand eventually new Living Garden habitats.",
