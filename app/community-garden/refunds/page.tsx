...
export const metadata: Metadata = { title: "Refund Policy | Basil Community Garden" };

export default function BasilRefundPage() {
  return (
    <BasilPolicyPage eyebrow="Garden Membership" title="Refund Policy">
      <section><h2>Our approach</h2><p>Garden Membership is a one-time $6.99 digital purchase delivered immediately after successful payment. If you bought it by mistake, were charged more than once, or cannot access the paid garden after reasonable troubleshooting, contact Basil Support within 14 days of purchase.</p></section>
