...
export default function BasilRefundPage() {
  return (
    <BasilPolicyPage eyebrow="Garden Membership" title="Refund Policy">
      ...
      <section><h2>Complimentary access</h2><p>A complimentary gift code does not involve a payment and therefore has no amount to refund or cash value. If gifted access is not working, contact Basil Support so the entitlement can be investigated.</p></section>
