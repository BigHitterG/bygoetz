...
export const metadata: Metadata = {
  title: "Terms of Use | Basil Community Garden",
  alternates: { canonical: getBasilUrl("/community-garden/terms") },
};
...
export default function BasilTermsPage() {
  return (
    <BasilPolicyPage eyebrow="Playing together" title="Terms of Use">
      ...
      <section><h2>Garden Membership</h2><p>Garden Membership is currently a one-time $9.99 digital purchase, not a subscription. Limited complimentary gift codes may also grant the same access without payment. Gift codes have no cash value, may be limited to one use, and may be revoked if obtained or used through abuse. Membership grants access to the current membership features, including saving My Garden across supported devices. Virtual Care, plants, paths, and objects are licensed game features, not money or property, and cannot be sold or transferred. Basil may evolve, rebalance, add, or retire features while preserving purchased access in a reasonable form.</p></section>
