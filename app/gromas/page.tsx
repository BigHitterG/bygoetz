  ...
  if (gromasPurchase.status === "available") {
    return (
      <a
        ...
        rel="noreferrer"
      >
        Buy the hardcover on {gromasPurchase.channel} · {gromasPurchase.displayPrice}
      ...
      <main id="main-content">
        <section className={styles.hero} aria-labelledby="book-title">
          ...
          <div className={styles.heroCopy}>
            ...
            <p className={styles.purchaseNote}>
              Printed to order through Lulu after the final physical proof is
              approved. Price and the verified purchase link will appear here
              at launch.
            </p>
          </div>
        </section>
        ...
        <section className={styles.formatSection} aria-labelledby="format-heading">
          ...
          <div className={styles.formatCopy}>
            ...
            <p>
              The planned Lulu edition pairs a compact read-aloud size with
            ...
            <p className={styles.formatFootnote}>
              Final manufacturing details remain subject to the approved Lulu
              project and physical proof.
            </p>
          </div>
        </section>
        ...
        <section className={styles.faqSection} aria-labelledby="faq-heading">
          <div className={styles.faqIntro}>
            ...
            <p>
              The book page is ready now; the purchase link stays closed until
              the print edition is truly ready.
            </p>
          </div>
          <div className={styles.faqList}>
            <details>
              ...
              <p>
                After the final print files and specifications are set and we
                review a physical Premium Color proof. If Global Distribution
                is selected, the ISBN will be finalized too. This page will then
                show the final price and verified Lulu purchase link.
              </p>
            </details>
            <details>
              <summary>Where will checkout happen?</summary>
              <p>
                On the verified Lulu purchase page. If Lulu Direct checkout is
                available for this project, we may use its hosted checkout.
                Bygoetz will not collect payment details itself.
              </p>
            </details>
            <details>
            ...
            <details>
              ...
              <p>
                The page uses the current v3 cover artwork and sample interior
                spreads. Final publication still depends on Lulu’s exact cover
                template, barcode, and our review of the physical proof.
              </p>
            </details>
          </div>
        </section>
        ...
        <section className={styles.finalCta} aria-labelledby="final-cta-heading">
          <div>
            <p className={styles.sectionKicker}>The adventure is almost ready</p>
            <h2 id="final-cta-heading">Take the first step with Gromas.</h2>
            <p>
              Preview the current story art today, then return here for the
              verified Lulu edition and launch price.
            </p>
          </div>
